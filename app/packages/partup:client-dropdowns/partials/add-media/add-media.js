var ClientDropdowns = Partup.client.ClientDropdowns;

Template.PartialDropdownAddMedia.onCreated(function() {
    var template = this;
...
Template.PartialDropdownAddMedia.helpers({
    menuOpen: function() {
